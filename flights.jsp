...
<body>
    ...
    %>
        ...
        %>
			<tr>
				...
				<td><a
					href="BookFlightServlet?airline=<%= flight.getAirline() %>&departureTime=<%= flight.getDepartureTime() %>&arrivalTime=<%= flight.getArrivalTime() %>&price=<%= flight.getPrice() %>&source=<%= source %>&destination=<%= destination %>"
					class="book-btn">Book Now</a></td>
			</tr>
			<%
            }
        %>
    ...
    %>
		<br> <a href="Home.html" class="back-btn">Go Back</a>
	</div>
